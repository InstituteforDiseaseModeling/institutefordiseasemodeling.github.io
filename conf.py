...
html_theme_options = {
    ...
    "icon_links": [
        ...
        {
            "name": "GitHub",
            "url": "https://institutefordiseasemodeling.github.io/",
...
html_baseurl = "https://institutefordiseasemodeling.github.io/"
html_context = {
    'rtd_url': 'https://docs.idmod.org/projects',
    "versions_dropdown": {
        "latest": "devel (latest)",
...
latex_documents = [
    (master_doc, 'IDM-docs.tex', u'IDM GitHub',
...
man_pages = [
    (master_doc, 'IDM-docs', u'IDM GitHub',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'IDM-docs', u'IDM GitHub',
     author, 'Institute for Disease Modeling', 'GH-Pages landing page.',
     'Miscellaneous'),
]
